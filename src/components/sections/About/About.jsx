      ...
      <Container>
        <div className='md:flex-none lg:flex xl:flex 2xl:flex justify-center items-center space-x-6 lg:mt-[100px] xl:mt-[100px] 2xl:mt-[100px]'>
          ...
          <div className='w-[90%] md:w-[75%] relative'>
            ...
            {/* aboutShadow */}
            <div className='absolute aboutShadow 2xl:w-[250px] xl:w-[250px] lg:w-[250px] 2xl:h-[250px] xl:h-[250px] lg:h-[250px] 2xl:top-[200px] xl:top-[200px] lg:top-[170px] 2xl:left-[100px] xl:left-[100px] lg:left-[80px]' />
